...
def detect_circles_for_cb(image: np.ndarray,
    ...
    Args:
        ...
        search_width: How far right to search from label (default: 340px)
        search_up: How far above label to search (default: 0px)
        search_height: Total height of search region (default: 130px)
...
def detect_cb_components(labels: List[CBLabel],
    ...
    Args:
        ...
        search_width: How far right to search (default: 340px)
        search_up: How far above label to search (default: 0px)
        search_height: Total height of search region (default: 130px)
        debug: Print debug info
...
def main():
    ...
    parser.add_argument('--search-width', type=int, default=340,
                       help='How far right to search for circles (default: 340px)')
    parser.add_argument('--search-up', type=int, default=0,
                       help='How far above label to search (default: 0px)')
    parser.add_argument('--search-height', type=int, default=130,
                       help='Total height of search region (default: 130px)')
